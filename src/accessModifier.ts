...
class Foreman3 extends Employee3{
    level : number ;
  constructor(name: string , age : number , experience: string[], level: number){
...
const employee2:Employee2 = new Employee2("Faraaz Ashraf", 23, ["Java", "JavaScript", "React.js"]) 
const forman2:Foreman2 = new Foreman2("Daniel", 24, ["C++", "React.js", "AWS"], 3)
...
const employee1:Employee = new Employee("Faraaz Ashraf", 23, ["Java", "JavaScript", "React.js"]) 
const forman1:Foreman = new Foreman("Daniel", 24, ["C++", "React.js", "AWS"], 3)
